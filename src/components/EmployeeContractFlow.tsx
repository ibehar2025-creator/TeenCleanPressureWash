    ...
    return <div className="mx-auto max-w-3xl space-y-5">
      ...
      <form onSubmit={signAndSend} className="space-y-5">
        <article className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900 sm:p-7">
          <div className="border-b border-slate-200 pb-5 dark:border-slate-700"><p className="text-sm font-semibold text-lagoon">TeenCleanPressureWash</p><h3 className="mt-1 text-xl font-bold text-ink dark:text-white">Recurring Power Washing Service Agreement</h3><p className="mt-1 text-xs text-slate-500">Prepared {new Date().toLocaleDateString()}</p></div>
          ...
          <div className="mt-6 space-y-3 text-sm leading-6 text-slate-600 dark:text-slate-300"><p>The customer authorizes TeenCleanPressureWash to provide the services listed above at the stated frequency and price. Service dates will be coordinated with the customer and may change because of weather, property access, or mutual scheduling needs.</p><p>Work outside the listed service scope requires customer approval and may have an additional charge. Either party may request a change to or cancellation of future service by contacting the other party before the next scheduled visit.</p><p>By signing below, the customer confirms that the information above is accurate and asks TeenCleanPressureWash to accept this recurring-service agreement. The signed agreement is submitted to the business owner for confirmation.</p></div>
        </article>
