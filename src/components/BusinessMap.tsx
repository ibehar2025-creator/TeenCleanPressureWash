...
const jobCoordinateCacheKey = "teencleanpressurewash-job-coordinate-cache-v1";
...
function coordinatesMatchAddress(address: string, latitude: number, longitude: number) {
  return isUsableJobAddress(address) && Number.isFinite(latitude) && Number.isFinite(longitude)
