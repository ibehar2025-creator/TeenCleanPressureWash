...
const upcomingJobsSheetUrl = import.meta.env.VITE_JOBS_SHEET_URL?.trim() ?? "";
...
function OwnerDashboard() {
  ...
  const [syncStatus, setSyncStatus] = useState("Loading your workspace.");
  ...
  const syncSheets = useCallback(async () => {
    ...
    setSyncing(true);
    setSyncStatus("Syncing business records...");
  ...
  async function addLead(draft: Omit<Lead, "id" | "source" | "websiteEditedFields">) {
    ...
    setSyncStatus("New lead saved to your business records.");
  }
